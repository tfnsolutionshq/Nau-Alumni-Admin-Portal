...
//         url: "https://unizikalumni-api.tfnsolutions.us/api/donations/create",
//         headers: {
...
//             <button className="flex items-center shadow p-1 text-gray-600" onClick={handleGoBack}>
//               <ArrowLeft className="w-4 h-4 mr-2" />
//               Go Back
//             </button>
//             <button
//               className="bg-[#D15300] text-white px-5 py-2 rounded-md disabled:opacity-50 disabled:cursor-not-allowed"
...
//                 <span className="block sm:inline"> Donation created successfully! Redirecting...</span>
//               </div>
//             )}
...
//                   ) : (
//                     <div
//                       className="border-2 border-dashed border-gray-300 bg-gray-50 rounded-md p-6 flex flex-col items-center justify-center h-56 cursor-pointer hover:border-orange-500 transition-colors"
