          ...
          <div className="px-6 py-4">
            ...
            <div className="grid grid-cols-1 border p-4 rounded lg:grid-cols-3 gap-6">
                    ...
                    >
                      ...
                      {employmentStatuses.map((status) => (
                        <option key={status} value={status}>
                          ...
                          {/* Capitalize first letter and replace dash */}
                        </option>
                      ))}
                    </select>
                    <ChevronDown className="absolute right-3 top-1/2 transform -translate-y-1/2 w-4 h-4 text-gray-500" />
              ...
              <div>
                <p className="font-medium mb-2">Place Image Here</p>
                <div
                  className="border-2 bg-gray-50 border-dashed border-gray-300 rounded-md p-6 flex flex-col items-center justify-center h-48 cursor-pointer overflow-hidden"
                  onClick={() => document.getElementById("profile-upload").click()}
                >
                  {imagePreview ? (
                    <img
